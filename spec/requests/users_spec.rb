...
RSpec.describe "Users API", type: :request do
  ...
  describe 'POST /users' do
    let(:valid_attributes) { { name: 'Alice', email: 'alice@gmail.com', campaigns_list: [{"campaign_name": "cam4", "campaign_id": "id4"}] } }
    ...
    context 'when the request is invalid' do
      ...
      it 'returns a validation failure message' do
        debugger
        expect(response.body).to match(/Validation failed: Email can't be blank, Campaigns list can't be blank/)
      end
    end
  end
